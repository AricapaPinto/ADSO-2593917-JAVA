...
public class ListarProductos extends javax.swing.JFrame {
    ...
    public ListarProductos(Menu ventanaMenu, Productos listaProductos []) {
    ...
    public void imprimirProductos(){
        for(int i = 0; i < this.listaProductos.length; i++){
            if(this.listaProductos[i] != null){
                etqTemporal = new JLabel(i + " " + this.listaProductos[i].getName()+" - "+this.listaProductos[i].getIdentificador()+" "+this.listaProductos[i].getcantidad()+" "+this.listaProductos[i].getPrecio()+" "+this.listaProductos[i].getfecha());
