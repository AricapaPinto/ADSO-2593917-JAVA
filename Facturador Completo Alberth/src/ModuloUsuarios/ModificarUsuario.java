...
public class ModificarUsuario extends javax.swing.JFrame {
    ...
    public ModificarUsuario(Menu ventanaMenu, Persona listaPersonas[], String titulo) {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if (!this.campoNombres.getText().equals("") && !this.campoApellidos.getText().equals("") && !this.campoTelefono.getText().equals("") && !this.campoDireccion.getText().equals("") && !this.campoEmail.getText().equals("")) {
            ...
            Persona temporal = new Persona(this.listaPersonas[this.getObtenerPosicion()].getCedula(), nombre, Apellidos, Telefono, Direccion, Email);
            this.listaPersonas[this.getObtenerPosicion()] = temporal;
        ...
        if (!this.campoCedula.getText().equals("")) {
            ...
            for (int i = 0; i < listaPersonas.length; i++) {
                if (listaPersonas[i] != null && this.listaPersonas[i].getCedula().equals(cedula_buscar)) {
                    ...
                    this.campoNombres.setText(this.listaPersonas[i].getNombres());
