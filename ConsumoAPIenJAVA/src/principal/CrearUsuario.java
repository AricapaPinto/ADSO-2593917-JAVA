...
public class CrearUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        etqFoto = new javax.swing.JLabel();
        ...
        contentTituloLayout.setVerticalGroup(
            contentTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(etqTitulo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        etqFoto.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        etqFoto.setText("Foto");
        etqFoto.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        ...
        campoFoto.setMargin(new java.awt.Insets(2, 5, 2, 5));
        campoFoto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                campoFotoeventoKeyCampos(evt);
            }
        });

        etqEmail1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        etqEmail1.setText("Email:");
        ...
        contentPrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(contentPrincipalLayout.createSequentialGroup()
                ...
                .addGroup(contentPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(contentPrincipalLayout.createSequentialGroup()
                        .addComponent(etqFoto, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(campoFoto, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(contentPrincipalLayout.createSequentialGroup()
                        .addGap(6, 6, 6)
        ...
        contentPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(contentPrincipalLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(contentPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(campoFoto, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(etqFoto, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(contentPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (!cedula.equals("") && !nombres.equals("") && !apellidos.equals("") && !direccion.equals("") && !telefono.equals("") && !email.equals("")) {
            ...
            // aqui insetamos los datos nuevos sin que se repitan
            // POST con Datos
            boolean CC_valida = false;
            for (int i = 0; i < listaPersonas.length; i++) {
                if (listaPersonas[i].getCedula().equalsIgnoreCase(cedula)) {
                    CC_valida = true;
                    break;
                }
            }
            ...
            if (CC_valida == false) {
                ...
                insertData.put("email", direccion);
                insertData.put("foto", foto);
    ...
    private void campoFotoeventoKeyCampos(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_campoFotoeventoKeyCampos
        // TODO add your handling code here:
    }//GEN-LAST:event_campoFotoeventoKeyCampos
    ...
    private javax.swing.JLabel etqFoto;
