...
public class EliminarUsuario extends javax.swing.JFrame {
    ...
    public EliminarUsuario(Menu ventMenu) {
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        if (!this.inputNombres.getText().equals("") && !this.inputApellidos.getText().equals("") && !this.inputTelefono.getText().equals("") && !this.inputDireccion.getText().equals("") && !this.inputCorreo.getText().equals("")) {
            ...
            for (int i = eliminar; i < ventMenu.listaPersonas.length - 1; i++) {
                ventMenu.listaPersonas[i] = ventMenu.listaPersonas[i + 1];
            }
            //aqui se destruye una vez guarde los cambios
            Eliminado_Exitoso ventana=new Eliminado_Exitoso(this.ventMenu);
    ...
    public void buscarCliente() {
        ...
        if (!inputEliminarUsuario.getText().equals("")) {
            ...
            for (int i = 0; i < ventMenu.listaPersonas.length; i++) {
                if (ventMenu.listaPersonas[i] != null && this.ventMenu.listaPersonas[i].getCedula().equals(cedula_ingresada)) {
                    this.label_encontrado.setText("Usuario encontrado :" + ventMenu.listaPersonas[i].getNombres());
                    System.out.println("Cedula=>" + this.ventMenu.listaPersonas[i].getCedula() + i);
                    encontrado = true;
                  
                   
                    //agregamos la informacion del usuario en los input para que los pueda modificar
                    this.inputNombres.setText(this.ventMenu.listaPersonas[i].getNombres());
                    this.inputApellidos.setText(this.ventMenu.listaPersonas[i].getApellidos());
                    this.inputTelefono.setText(this.ventMenu.listaPersonas[i].getTelefono());
                    this.inputDireccion.setText(this.ventMenu.listaPersonas[i].getDireccion());
                    this.inputCorreo.setText(this.ventMenu.listaPersonas[i].getEmail());
