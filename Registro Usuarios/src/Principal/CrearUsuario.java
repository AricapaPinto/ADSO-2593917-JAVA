...
public class CrearUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        contentTituloLayout.setHorizontalGroup(
            ...
            .addComponent(etqTitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)
        );
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (!cedula.equals("") && !nombres.equals("") && !apellidos.equals("") && !direccion.equals("") && !telefono.equals("") && !email.equals("") ) {
            ...
            for(int i=0;i<ventanaMenu.listaPersonas.length;i++){
               if(ventanaMenu.listaPersonas[i]==null){
                   ventanaMenu.listaPersonas[i]=temporal;
                   break;
               }
            }
